<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Category.ascx.cs" Inherits="NBU.PayBill.Salary.Controls.Category" %>
<div class="form-row">
    <div class="form-group col-md-12 well well-sm">
        <asp:Label ID="uc_lbl_title" ClientIDMode="Static" CssClass="h3" runat="server" Text="Add New Category"></asp:Label>
    </div>
</div>
<div class="form-row">
